...
function temperatureCtoF(temp) {
  let calculate = (temp * 9) / 5 + 32;
  console.log(`${temp}C to F is: ${calculate}`);
  return (temp * 9) / 5 + 32;
}
temperatureCtoF(0);
...
function temperatureInF(temp, unit) {
  if (unit === "F") {
    ...
    //   console.log(`${(temp * 9) / 5 + 32} Temperature: ${temp}. Unit: ${unit}`);
    // return `${(temp * 9) / 5 + 32} Temperature: ${temp}. Unit: ${unit}`;
  }
}
temperatureInF(50, "F");
/**
...
makePersonObject(1, "Brian", "brianbaroff@gmail.com");
...
function appleIndex(fruit) {
  console.log(`The index of 'apple' is: ${fruit.indexOf("apple")}`);
  return fruit.indexOf("apple");
}
appleIndex(["orange", "grape", "apple", "banana"]);
/**
...
let input = ["orange", "apple", "banana", "apples", "apple", "mango"];
let output = isItAnApple(input);
console.log(output);
...
function getCarInfoByIndex(inventory, index) {
  ...
  console.log(`This is a ${car.car_make} ${car.car_model}`);
...
function getModelYears(inventory) {
  ...
  for (let i = 0; i < inventory.length; i++) {
    ...
    newArray.push(currentCar.car_year);
  }
  return newArray;
}

output = getModelYears(inventory);
console.log(output);
/**
